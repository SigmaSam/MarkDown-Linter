...
describe Scaner do
  ...
  it 'It returns false when it finds no errors' do
    expect(scan.scan_line(file)).to be(false)
  end

  it 'It returns true when it finds errors' do
    expect(scan.scan_line(file_error)).to be(true)
  end
  ...
  it 'It raises an exception for invalid input' do
    expect { scan.sym_check }.to raise_error
  end
  ...
  it 'It raises an exception for invalid input' do
    expect { scan.find_pair }.to raise_error
  end
end
